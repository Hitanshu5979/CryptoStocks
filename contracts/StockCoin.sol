...
contract StockCoin is Ownable {
    ...
    */
    constructor (string memory token_name, string memory short_symbol, uint8 token_decimals, uint256 token_totalSupply) {
        ...
        // Emit an Transfer event to notify the blockchain that a Transfer has occured
    ...
    */
    function _mint (address account, uint256 amount) internal {
        ...
        require(account != address(0), "StockCoin: cannot mint to zero address");
    ...
    */
    function _burn (address account, uint256 amount) internal {
        ...
        require (account != address(0), "StockCoin: cannot burn from zero address");
        require (_balances[account] >= amount, "StockCoin: cannot burn more than the account owns");

        // Remove the amount from the account balance
        _balances[account] = _balances[account] - amount;

        //Decerease totalSupply
        _totalSupply = _totalSupply - amount;

        // Emit event, user zero address as receiver
    ...
    */
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        require(sender != address(0), "StockCoin: transfer from zero address");
        require(recipient != address(0), "StockCoin: transfer from zero address");
        require(_balances[sender] >= amount, "StockCoin: cant transfer more than your account holds");
   ...
   *   - owner and spender cannot be zero address
    */
    function _approve(address owner, address spender, uint256 amount) internal {
        ...
        require(owner != address(0), "StockCoin: approve cannot be done from zero address");
        require(spender != address(0), "StockCoin: approve cannot be to zero address");
    ...
    */
    function transferFrom (address spender, address recipient, uint256 amount) external returns (bool) {
        ...
        require(_allowances[spender][msg.sender] >= amount, "StockCoin: You cannot spend that much on this account");
