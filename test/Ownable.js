...
const Ownable = artifacts.require("StockCoin");
...
contract ("Ownable", async accounts => {
    ...
    it ("transfer ownership", async () => {
        ...
        // Verify that account 1 is now the new owner
    ...
    it ("renounce ownership", async() => {
        ...
        assert.equal(owner, '0x0000000000000000000000000000000000000000', 'Renouncing owner was not corredctly done')
